                ...
                >
                  ...
                  <div className="flex gap-3 flex-shrink-0">
                    <button
                      ...
                      className="bg-blue-600 text-white px-5 py-2 rounded-xl text-sm font-semibold hover:bg-blue-700 transition shadow-sm"
                    >
                      Accept
                    </button>
                    <button
                      onClick={() => { setRejectModal(appt); setRejectReason(""); }}
                      className="bg-white border border-gray-200 text-gray-700 px-5 py-2 rounded-xl text-sm font-semibold hover:bg-gray-50 transition"
                    >
                      Decline
                    </button>
                  </div>
