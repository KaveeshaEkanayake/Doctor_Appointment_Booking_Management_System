...
export default function AboutPage() {
     ...
     const features = [
    {
      ...
      description:
        "Our platform exclusively partners with highly qualified doctors who bring expertise and commitment to delivering top-notch healthcare.",
    },
    {
      icon: IconClock,
      title: "24 Hours Service",
      description:
        "Experience healthcare access with our 24/7 service. Whether day or night, you can find and book appointments easily.",
    },
    {
      icon: IconLab,
      title: "Quality Lab Services",
      description:
        "Partnering with accredited labs, your health is our priority, and our quality lab services reflect our dedication to excellence.",
    },
    {
      icon: IconConsult,
      title: "Free Consultations",
      description:
        "Your well-being is important, and our commitment to providing accessible care begins with a free initial consultation.",
    },
  ];
          ...
          <div className="w-full h-full overflow-x-hidden bg-white">
            {/* Hero Section */}
              ...
              <section className="w-full bg-white py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-1">
                    ...
                    {/* <div className="rounded-2xl overflow-hidden h-[180px] col-span-2">
                        <img src={Img02} alt="Female doctor" className="w-full h-full object-cover" />
                    </div> */}
                </div>
                ...
                <div className="w-full h-full mt-10">
                  ...
                  <p className="text-gray-600 text-base md:text-lg leading-8 mb-6">
                    At MediCare, we understand that healthcare should be simple, fast,
                    and accessible for everyone. Our mission is to streamline the
                    process of finding trusted doctors and booking appointments online,
                    so patients can receive quality medical care without delays or
                    complications.
                  </p>

                  <p className="text-gray-600 text-base md:text-lg leading-8 mb-10">
                    We provide a smart and user-friendly platform that connects patients
                    with qualified healthcare professionals across multiple specialties.
                    Whether you need a routine check-up, specialist consultation,
                    follow-up visit, or urgent medical attention, MediCare makes it easy
                    to schedule appointments anytime, anywhere.
                  </p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-semibold text-[#0b1b3f]">
                        +11 2345789
                      </p>
                    </div>
                  </div>
              ...
              <section className="py-1 sm:py-16 lg:py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="text-center mb-10 sm:mb-12">
                    <p className="text-blue-600 font-medium text-base sm:text-lg mb-2">
                      Our Features
                    </p>
                    <h2 className="text-3xl md:text-4xl xl:text-4xl font-bold text-[#0b1b3f] leading-tight mb-6 
              ...
              {/* Section 04 */}
              <section className="relative bg-blue-500 py-8 px-4 md:px-6 lg:px-12 
                                max-w-7xl mx-auto my-12 rounded-2xl overflow-hidden h-[450px]">
              ...
              {/* Decorative circle */}
              <div className="absolute right-10 top-1/2 w-24 h-24 md:w-40 md:h-40 
                ...
                <div className="mt-0 md:mt-0 lg:mt-10">
                  <div className="space-y-6">
                    ...
                    <div className="mt-0 md:mt-6 lg:mt-20">
                      ...
                      <p className="text-gray-30 text-sm md:text-base leading-relaxed">
                    ...
                    <div className="bg-blue-100 rounded-lg p-2">
                      <h3 className="text-md ml-4 font-semibold text-black-600 mb-2 flex items-center justify-between cursor-pointer">
                        Can I Request A Specific Doctor When Booking My Appointment?
                        {/* <span className="text-blue-500">[+]</span> */}
                        <button 
                        className="bg-white item-center rounded-lg mt-1 mr-2 w-8 h-8"
                        onClick={handleClick} 
                        > 
                        +
                        </button>
